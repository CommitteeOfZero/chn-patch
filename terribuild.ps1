...
Copy-Item $languagebarrier_dir\LanguageBarrier\x64\$languagebarrier_configuration\*.dll .\DIST
Copy-Item $languagebarrier_dir\LanguageBarrier\x64\$languagebarrier_configuration\*.pdb .\symbols
Copy-Item -Recurse $languagebarrier_dir\LanguageBarrier\x64\$languagebarrier_configuration\languagebarrier .\DIST
Remove-Item -Force -Recurse $languagebarrier_dir\LanguageBarrier\x64
...
# DXVK
Copy-Item .\DIST\d3d9 ".\DIST\HEAD NOAH"
Copy-Item .\DIST\d3d10 ".\DIST\HEAD NOAH"
Copy-Item .\DIST\d3d10_1 ".\DIST\HEAD NOAH"
Copy-Item .\DIST\d3d10core ".\DIST\HEAD NOAH"
Copy-Item .\DIST\d3d11 ".\DIST\HEAD NOAH"
Copy-Item .\DIST\dxgi ".\DIST\HEAD NOAH"
